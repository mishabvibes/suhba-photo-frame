      ...
      <div className="hidden md:flex md:w-[450px] bg-[#1b2236] p-12 text-white flex-col justify-between relative">
        ...
        <div className="z-10">
          <div className="flex items-center mb-12">
            ...
            <span className="ml-3 text-xl font-bold text-white">SUHBA UNION</span>
          </div>
          
          {/* Main content */}
          <h1 className="text-4xl font-bold mb-6 text-white">Admin Portal</h1>
          <p className="text-xl text-gray-300 mb-12">Access your dashboard and manage content with confidence.</p>
          ...
          <div className="space-y-8">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-sm text-gray-400">End-to-end encryption protects your administrative operations.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-sm text-gray-400">Fine-grained admin tools for complete content management.</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div>
                <button
                  ...
                  className={`w-full flex justify-center items-center py-2.5 px-4 rounded-lg text-white transition-colors duration-150 ${
                    isLoading ? 'bg-indigo-600 cursor-not-allowed opacity-70' : 'bg-indigo-500 hover:bg-indigo-600'
                  }`}
                >
                  {isLoading ? (
                    <>
